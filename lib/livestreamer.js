...
function Livestreamer(settings, file, ch) {
  var that = this;
  this.file = file;
  ...
  var livestreamerSettings = [];
  if(settings.mpv) {
    Array.prototype.push.apply(livestreamerSettings, settings.mpv);
  }
  Array.prototype.push.apply(livestreamerSettings, [this.file, "best"]);

  this.proc = spawn('livestreamer', livestreamerSettings, { stdio: 'inherit', env: env });
...
Livestreamer.prototype.mpv_send = function(command, onSuccess, onFailure) {
    var that = this;
...
Livestreamer.prototype.quit = function() {
  var that = this;
...
Livestreamer.prototype.timeRemaining = function() {
  var that = this;
  var onSuccess = function(response) {
...
Livestreamer.prototype.pause = function(on) {
  var that = this;
  var onSuccess = function(response) {
...
Livestreamer.prototype.mute = function(on) {
  var that = this;
  this.on = on;
  var onSuccess = function(response) {
...
Livestreamer.prototype.filename = function() {
  var that = this;
  var onSuccess = function(response) {
    if(response.error=="success") {
...
Livestreamer.prototype.subs = function(on) {
  var that = this;
  var onSuccess = function(response) {
    //that.channel.say(that.name()+' pause '+ that.on.toString().irc.bold());
  }
...
Livestreamer.prototype.audioTrack = function(channel, id) {
  var that = this;
  var onSuccess = function(response) {
    //that.channel.say(that.name()+' pause '+ that.on.toString().irc.bold());
  }
...
Livestreamer.prototype.subtitleTrack = function(channel, id) {
  var that = this;
  var onSuccess = function(response) {
    //that.channel.say(that.name()+' pause '+ that.on.toString().irc.bold());
  }
...
Livestreamer.prototype.seekSeconds = function(channel, s) {
  var that = this;
  var onSuccess = function(response) {
    //that.channel.say(that.name()+' pause '+ that.on.toString().irc.bold());
  }
